...
Then, there are some documents/templates to follow. You can read them in [this repository](https://github.com/D-Gine/.github) and have to use the appropriated ones when contributing.
